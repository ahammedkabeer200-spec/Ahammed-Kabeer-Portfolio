        document.addEventListener('DOMContentLoaded', () => {
            ...
            const cableTable = [
                ...
                { size: 70.0,  xlpe: 268, pvc: 196,  mvSingle: 0.63,   mvThree: 0.55,   mcb: "200A MCCB" },
                { size: 95.0,  xlpe: 328, pvc: 241,  mvSingle: 0.46,   mvThree: 0.40,   mcb: "250A MCCB" },
                { size: 120.0, xlpe: 383, pvc: 282,  mvSingle: 0.36,   mvThree: 0.31,   mcb: "315A MCCB" },
                { size: 150.0, xlpe: 444, pvc: 324,  mvSingle: 0.29,   mvThree: 0.25,   mcb: "350A MCCB" },
                { size: 185.0, xlpe: 510, pvc: 371,  mvSingle: 0.23,   mvThree: 0.20,   mcb: "400A MCCB" },
                { size: 240.0, xlpe: 607, pvc: 439,  mvSingle: 0.175,  mvThree: 0.155,  mcb: "500A MCCB" },
                { size: 300.0, xlpe: 703, pvc: 508,  mvSingle: 0.145,  mvThree: 0.130,  mcb: "630A ACB / MCCB" },
                { size: 400.0, xlpe: 823, pvc: 594,  mvSingle: 0.115,  mvThree: 0.105,  mcb: "800A ACB / MCCB" }
            ];
            ...
            const updateCableCalc = () => {
                ...
                // Update UI elements
                const formattedSize = Number.isInteger(chosenCable.size) ? chosenCable.size.toString() : chosenCable.size.toFixed(1);
                if (cableResSize) cableResSize.textContent = formattedSize;
